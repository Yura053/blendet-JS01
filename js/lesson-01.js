...
// const number = Number(prompt("Введіть число"));
// if (min >= 45 && min < 60) {
//   alert(`${min} лужить у четвертій чверті`);
// } else if (min >= 30 && min < 45) {
//   alert(`${min} лужить у четвертій чверті`);
// } else if (min >= 15 && min < 30) {
//   alert(`${min} лужить у другій чверті`);
// } else if (min >= 0 && min < 15) {
//   alert(`${min} лужить у першій чверті`);
// }
// Task 3
...
// const num = Number(prompt("Write minutes"));

// console.log(convertMinutesToTime(num));
...
//     return true;
//   } else {
//     return confirm("Вам менше 18 років. Ви впевнені?");
//   }
// }
